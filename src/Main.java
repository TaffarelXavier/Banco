...
/**
 * Esta classe é responsável por iniciar o programa. No primeiro método (Main), iniciarPrograma, são criados alguns vetores, a saber: de Clientes, contas e etc. Criação da Empresa, na variável banco,
 * que foi instanciada da classe Empressa, porque todo Banco é uma empresa.
 *
 * Para ter noção
 *
...
public class Main {
    ...
    public static void IniciarPrograma() {
        ...
        Empresa banco = new Empresa("TRD LTDA",
                        ...
                        while (logado) {
                            ...
                            switch (opcaoFunciona) {
                                ...
                                case 5:
                                    ...
                                    System.out.print("Pesquisar cliente por CPF:");
