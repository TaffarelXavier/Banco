...
public class Conta {
    ...
    public boolean isIsConjugado() {
        return isConjugado;
    }

    public void setIsConjugado(boolean isConjugado) {
        this.isConjugado = isConjugado;
    }
     ...
     * @param banco
     */
    public void setBanco(Empresa banco) {
        this.banco = banco;
    }
